...
# desafio_ds_transito documentation build
...
from desafio_ds_transito import __version__ as release

# -- Project information -----------------------------------------------------

project = "desafio_ds_transito"
author = "Kedro"
...
htmlhelp_basename = "desafio_ds_transitodoc"
...
latex_documents = [
    (
        master_doc,
        "desafio_ds_transito.tex",
        "desafio_ds_transito Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "desafio_ds_transito",
        "Project desafio_ds_transito codebase.",
        "Data-Science",
    )
]
